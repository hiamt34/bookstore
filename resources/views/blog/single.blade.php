...
<div class="page-content">
    <figure class="entry-media">
        <img src="/storage/images/blog/single/fullwidth/1.jpg" alt="image desc">
        ...
        <article class="entry single-entry entry-fullwidth">
                ...
                <div class="col-lg-11">
                    <div class="entry-body">
                        ...
                        <div class="entry-content editor-content">
                            ...
                            <img src="/storage/images/blog/single/fullwidth/2.jpg" alt="image">
                            ...
                            <img src="/storage/images/blog/single/fullwidth/3.jpg" alt="image">
            ...
            <div class="entry-author-details">
                <figure class="author-media">
                    <a href="#">
                        <img src="/storage/images/blog/single/author.jpg" alt="User name">
                    </a>
                    ...
                    <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1188px;">
                        <div class="owl-item active" style="width: 277px; margin-right: 20px;">
                            <article class="entry entry-grid">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="/storage/images/blog/grid/3cols/post-1.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                        ...
                        <div class="owl-item active" style="width: 277px; margin-right: 20px;">
                            <article class="entry entry-grid">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="/storage/images/blog/grid/3cols/post-2.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                        ...
                        <div class="owl-item active" style="width: 277px; margin-right: 20px;">
                            <article class="entry entry-grid">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="/storage/images/blog/grid/3cols/post-3.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                        ...
                        <div class="owl-item active" style="width: 277px; margin-right: 20px;">
                            <article class="entry entry-grid">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="/storage/images/blog/grid/3cols/post-4.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
